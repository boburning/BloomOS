...
| Theme installation | themeSwitcher plus MainUI-specific resources | Fixed Bloom design system; legacy theme reconciliation only inside the explicit Developer MainUI fallback | Host regression for missing/malformed state; physical boot appearance remains pending |
