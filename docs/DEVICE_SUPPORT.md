...
| 2026-08-16 | Miyoo Mini Flip (model ID 285) | `v0.1.0-dev-bc086aa6` | Upgrade install, identity, display/input/battery/lid inventory, Wi-Fi capability, shutdown, Windows FAT check | Clean install and boot; native 752×560 panel; two input devices; hall sensor present with open-lid raw value 1; live AXP battery 64%; Wi-Fi capability true | FAT entered Linux with the not-properly-unmounted warning and returned to Windows dirty. No filesystem damage was found by CHKDSK. Shutdown verification and lid behavior require another controlled cycle. |
