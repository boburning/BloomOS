...
| [#1920](https://github.com/OnionUI/Onion/pull/1920) | Pico-8 standalone documentation | Documentation | Yes | Port the guidance when Bloom's emulator documentation is established. | Docs backlog |
...
| [#1897](https://github.com/OnionUI/Onion/pull/1897) | SQLite WAL and busy timeout | Reliability/database | Yes, high value | Port only with concurrency, migration, power-loss, and SD-card tests. WAL changes durability and sidecar-file behavior and is not a two-line blind cherry-pick. | Phase 3 |
