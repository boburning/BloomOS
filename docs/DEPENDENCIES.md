...
package payload into 156 independently resolvable components covering 2,656
...
The source-wrapper and replacement pass identifies 141 package components and shared
...
binaries they select. The remaining 15 components contain runtime payloads,
